...
const Profile = () => {
  ...
  const isBusinessApproved = user?.business?.is_approve;
  const shouldBlockBusinessUpdate = user?.business?._id && isBusinessApproved === false;
  useEffect(() => {
  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      {
        user?.business?._id && (
          shouldBlockBusinessUpdate ? (
            <Card className="mt-6 rounded-2xl border border-amber-200 bg-amber-50">
              <div className="text-center py-10 px-4">
                <p className="text-2xl font-semibold text-amber-700 mb-2">Pending Admin Approval</p>
                <p className="text-amber-800 max-w-xl mx-auto">
                  Thanks for submitting your business details. Our team is reviewing them right now.
                  Once your account is approved, you’ll be able to update your business information from here.
                </p>
              </div>
            </Card>
          ) : (
