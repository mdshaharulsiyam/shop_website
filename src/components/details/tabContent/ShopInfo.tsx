  ...
  return (
    ...
    >
      <div style={{
        ...
        <img className="w-[70px] h-[70px] object-cover rounded-lg" src={imageUrl(business?.logo)} />
      ...
      <ul className="flex items-start justify-start flex-col mt-3 list-disc pl-4 space-y-1">
        ...
        <li className=" font-medium">Address : {business ? business?.address : 'Mall Product'}</li>
        {business && <li className=" font-medium">Member since : {moment(business?.createdAt).format('YYYY-MM-DD')}</li>}
      </ul>
