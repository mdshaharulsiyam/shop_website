...
const Product = () => {
  ...
  // fetch products sorted by stock (desc)
  const { data, isLoading, isError } = useGetAllProductQuery({ order: 'desc', sort: 'stock', page: 1, limit: 12 })

  // map API to card shape
  ...
  // responsive columns and slide chunking (mobile shows 4 per slide)
